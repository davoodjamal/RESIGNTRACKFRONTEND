      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
               ...
               <div className="flex items-center gap-3">
                  ...
                  <span className={`px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider ${
                     resignation.status === 'Approved' ? 'bg-[#d8e2ff] text-[#001a42]' : resignation.status === 'Withdrawn' ? 'bg-[#76777d] text-white' : 'bg-[#ffe082] text-[#5a4300]'
                  }`}>
                     {resignation.status}
                  </span>
               </div>
                  ...
                  {steps.map((step, idx) => (
                     <div key={idx} className="flex flex-col items-center gap-4 w-1/4">
                        <div className={`w-14 h-14 rounded-full flex items-center justify-center transition-all shadow-sm ${
                           step.status === 'completed' ? 'bg-[#00dbe9] text-white' :
         ...
         <div className="lg:col-span-7 bg-[#1f1f24] rounded-2xl p-8 shadow-sm border border-[#3b494b] flex flex-col">
            ...
            <div className="space-y-4 flex-1">
               <div className="flex items-center gap-5 p-5 bg-[#1f1f24] rounded-xl border border-[#3b494b] hover:border-[#00dbe9] transition-all group cursor-pointer shadow-sm">
                  <div className="w-6 h-6 rounded border-2 border-[#00dbe9] flex items-center justify-center group-hover:bg-[#00dbe9]/10 transition-colors"></div>
                  ...
                  <Icon className="text-[#76777d] group-hover:text-[#00dbe9] transition-colors text-[20px]">arrow_forward_ios</Icon>
               </div>
               <div className="flex items-center gap-5 p-5 bg-[#1f1f24] rounded-xl border border-[#3b494b] hover:border-[#00dbe9] transition-all group cursor-pointer shadow-sm">
                  <div className="w-6 h-6 rounded border-2 border-[#00dbe9] flex items-center justify-center group-hover:bg-[#00dbe9]/10 transition-colors"></div>
                  <div className="flex-grow">
