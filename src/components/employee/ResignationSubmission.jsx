...
export default function ResignationSubmission({ user, systemSettings, onSubmitResignation }) {
  ...
  const reasonOptions = Array.isArray(systemSettings?.reasons) && systemSettings.reasons.length
    ? systemSettings.reasons
    : ['Career Growth', 'Better Opportunity', 'Higher Education', 'Health & Medical', 'Personal Reasons', 'Other'];
